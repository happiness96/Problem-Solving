...
if __name__ == '__main__':
    ...
    while turn <= 1000:
        for i in range(1, K + 1):
            ind = horse_status[horse[i][0]][horse[i][1]].index(i)

            horse_row = horse[i][0]
            horse_col = horse[i][1]
            horse_dir = horse[i][2]

            horses = horse_status[horse_row][horse_col][ind:]
            horse_status[horse_row][horse_col] = horse_status[horse_row][horse_col][:ind]
